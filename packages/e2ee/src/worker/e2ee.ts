...
const selfDeriveKeyMap: Map<string, { connectionId: string; keyId: number; deriveKey: CryptoKey }> = new Map();
...
function parsePayload(payloadType: keyof UnencryptedBytes, payload: Chunk["data"]): [Uint8Array, Uint8Array] {
  return [
...
function encodeFrameAdd(header: Uint8Array, sframeHeader: Uint8Array, connectionId: string): Uint8Array {
