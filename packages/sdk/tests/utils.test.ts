...
test("createSignalingMessage simple sendonly", () => {
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, {}, false)).toEqual(baseExpectedMessage);
});

test("createSignalingMessage simple recvonly", () => {
  const expectedMessage = Object.assign({}, baseExpectedMessage, { role: "recvonly" });
  expect(createSignalingMessage(sdp, "recvonly", channelId, undefined, {}, false)).toEqual(expectedMessage);
});

test("createSignalingMessage simple sendrecv", () => {
  const expectedMessage = Object.assign({}, baseExpectedMessage, { role: "sendrecv", multistream: true });
  expect(createSignalingMessage(sdp, "sendrecv", channelId, undefined, { multistream: true }, false)).toEqual(expectedMessage);
});
...
test("createSignalingMessage sendrecv and multistream: false", () => {
  ...
  }).toThrow(Error("Failed to parse options. Options multistream must be true when connecting using 'sendrecv'"));
});
...
test("createSignalingMessage metadata", () => {
  ...
  expect(createSignalingMessage(sdp, "sendonly", channelId, metadata, {}, false)).toEqual(expectedMessage);
});

test("createSignalingMessage metadata: null", () => {
  const expectedMessage = Object.assign({}, baseExpectedMessage, { metadata: null });
  expect(createSignalingMessage(sdp, "sendonly", channelId, null, {}, false)).toEqual(expectedMessage);
});
...
test("createSignalingMessage multistream: true", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { multistream: options.multistream });
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, options, false)).toEqual(expectedMessage);
});
...
test("createSignalingMessage video parameters", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { video: {
...
test("createSignalingMessage signalingMetadata", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { signaling_notify_metadata: options.signalingNotifyMetadata });
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, options, false)).toEqual(expectedMessage);
});
...
test("createSignalingMessage dataChannelSignaling: true", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { data_channel_signaling: options.dataChannelSignaling });
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, options, false)).toEqual(expectedMessage);
});
...
test("createSignalingMessage ignoreDisconnectWebSocket: true", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { ignore_disconnect_websocket: options.ignoreDisconnectWebSocket });
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, options, false)).toEqual(expectedMessage);
});
...
test("createSignalingMessage redirect: true", () => {
  ...
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, {}, true)).toEqual(expectedMessage);
});
...
test("createSignalingMessage dataChannels", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { data_channels: [
...
test("createSignalingMessage simulcastRid", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { simulcast_rid: options.simulcastRid });
  // @ts-ignore option で指定されている型以外を引数に指定する
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, options, false)).toEqual(expectedMessage);
});
...
test("createSignalingMessage spotlightFocusRid", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { spotlight_focus_rid: options.spotlightFocusRid });
  // @ts-ignore option で指定されている型以外を引数に指定する
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, options, false)).toEqual(expectedMessage);
});
...
test("createSignalingMessage spotlightUnfocusRid", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { spotlight_unfocus_rid: options.spotlightUnfocusRid });
  // @ts-ignore option で指定されている型以外を引数に指定する
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, options, false)).toEqual(expectedMessage);
});
...
test("createSignalingMessage spotlightNumber", () => {
  ...
  const expectedMessage = Object.assign({}, baseExpectedMessage, { spotlight_number: options.spotlightNumber });
  expect(createSignalingMessage(sdp, "sendonly", channelId, undefined, options, false)).toEqual(expectedMessage);
});
