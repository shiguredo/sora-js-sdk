...
(function (global, factory) {
  ...
  function createSignalingMessage(offerSDP, role, channelId, metadata, options) {
    ...
    const audioOpusParamsPropertyKeys = ['audioOpusParamsChannels', 'audioOpusParamsClockRate', 'audioOpusParamsMaxplaybackrate', 'audioOpusParamsStereo', 'audioOpusParamsSpropStereo', 'audioOpusParamsMinptime', 'audioOpusParamsPtime', 'audioOpusParamsUseinbandfec', 'audioOpusParamsUsedtx'];
